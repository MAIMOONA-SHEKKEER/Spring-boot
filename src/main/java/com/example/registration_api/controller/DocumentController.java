...
public class DocumentController {
    ...
    @GetMapping("/document")
    public String generateDocument(@RequestParam(required = false, defaultValue = "Guest") String userName,
            Model model) {
        // Sample Data
    ...
    public void generatePdf(@RequestParam(required = false, defaultValue = "Guest") String userName,
